Shader "Hidden/FogVolume"
{
	...
	#pragma multi_compile _ _FOG_LOWRES_RENDERER //Deben estar las dos disponibles			
	...
	#pragma shader_feature _FOG_GRADIENT_AFFECT_AMBIENT 
...
//opacity pass . Only for shadow rt
		SubShader
		{
			...
			#pragma shader_feature  SAMPLING_METHOD_ViewAligned
			#pragma shader_feature HEIGHT_GRAD
			#pragma shader_feature Twirl_X Twirl_Y Twirl_Z
			#pragma shader_feature DF
