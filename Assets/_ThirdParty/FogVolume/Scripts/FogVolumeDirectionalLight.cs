...
public class FogVolumeDirectionalLight : MonoBehaviour
{
    ...
    void OnEnable()
    {
        Transform fogVolumeDebugCanvas = transform.Find("FogVolume Debug Canvas");

        if (fogVolumeDebugCanvas != null)
        {
            _GO_Canvas = fogVolumeDebugCanvas.gameObject;
        }
        else
        {
            if (_GO_Canvas == null) _GO_Canvas = new GameObject("FogVolume Debug Canvas");
            _GO_Canvas.transform.SetParent(transform);
        }

        Transform fogVolumeDebugCanvasImage = _GO_Canvas.transform.Find("FogVolume Image");
        if (fogVolumeDebugCanvasImage != null)
            _GO_Image = fogVolumeDebugCanvasImage.gameObject;
        else
        {
        ...
        if (_GO_Canvas.GetComponent<Canvas>())
        {
        ...
        {
            _Canvas = _GO_Canvas.AddComponent<Canvas>();
        }
        ...
        if (_GO_Image.GetComponent<Image>())
        {
        ...
        if (_CanvasScaler == null)
            _CanvasScaler = _GO_Canvas.GetComponent<CanvasScaler>();

        if (_CanvasScaler == null)
            _CanvasScaler = _GO_Canvas.AddComponent<CanvasScaler>();
    ...
    void Update()
    {
        if (_CanvasImage != null && _CanvasImage.material != null) _CanvasImage.material = DebugViewMaterial;
