...
{
    public InMainMenuState(StateMachine stateMachine, CoreEvent coreEvent) : base(stateMachine, coreEvent, CoreStateType.InMainMenuState)
    {
    }
...
{
    public InSessionState(StateMachine stateMachine, CoreEvent coreEvent) : base(stateMachine, coreEvent, CoreStateType.InSessionState)
    {
    }
...
{
    public PauseSessionState(StateMachine stateMachine, CoreEvent coreEvent) : base(stateMachine, coreEvent, CoreStateType.PauseSessionState)
    {
    }
    public override void HandleAction(UIActionType action)
    {
